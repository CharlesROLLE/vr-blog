<nav class="nav-links  bg-gray-800" x-data="{open: false}">
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <a href="/" class="flex-shrink-0 flex items-center">
                    <img class="block lg:hidden h-8 w-auto" src="{{asset('img/vr_blog_logo.png')}}" alt="Workflow">
                    <img class="hidden lg:block h-8 w-auto" src="{{asset('img/vr_blog_logo.png')}}" alt="Workflow">
                </a>
                <div class="hidden sm:block sm:ml-6">
                    <div class="flex space-x-4">
                        <a href="{{ route('index') }}" class="{{Request::routeIs('index') ? 'activa' : 'text-gray-500'}}">Home</a>

                        <a href="{{ route('posts.index') }}"
                            class="{{Request::routeIs('posts.index') ? 'activa' : 'text-gray-500'}}">Blog</a>
                    ...
                    <div x-show="open" x-on:click.away="open = false"
                        ...
                        <a href="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1"
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                @csrf
                                <a href="{{ route('logout') }}" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2" @click.prevent="$root.submit();">Cerrar
                                    sesión</a>
                            </form>
                    </div>
                </div>
